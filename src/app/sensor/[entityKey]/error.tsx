...
/**
 * Route-level error boundary for /sensor/[entityKey].
 *
...
export default function SensorDetailError({
  error,
  reset,
}: {
    ...
    <div className="flex h-screen w-screen items-center justify-center bg-zinc-950 p-8">
      <div className="max-w-md rounded-2xl border border-red-500/30 bg-zinc-900/90 p-8 text-center shadow-2xl backdrop-blur-md">
        ...
        <p className="mb-1 text-sm text-zinc-400">
          The sensor detail page could not be loaded. The device may not
          exist or the network is unavailable.
        </p>
        {error.message && (
